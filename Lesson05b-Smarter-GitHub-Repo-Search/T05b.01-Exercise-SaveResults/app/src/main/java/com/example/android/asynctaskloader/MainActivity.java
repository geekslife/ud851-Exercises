...
public class MainActivity extends AppCompatActivity {
    ...
    final static String KEY_QUERY_URL = "QUERY_URL";

    // DONE (2) Create a static final key to store the search's raw JSON
    final static String KEY_SEARCH_JSON = "SEARCH_JSON";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // DONE (9) If the savedInstanceState bundle is not null, set the text of the URL and search results TextView respectively
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        mSearchResultsTextView.setText( savedInstanceState.getString(KEY_SEARCH_JSON));
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String queryUrlString = mUrlDisplayTextView.getText().toString();
        outState.putString(KEY_QUERY_URL, queryUrlString);

        String searchResultString = mSearchResultsTextView.getText().toString();
        outState.putString(KEY_SEARCH_JSON, searchResultString);
    }
